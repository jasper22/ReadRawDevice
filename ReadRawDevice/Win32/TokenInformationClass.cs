...
{
    /// <summary>
    /// Passed to GetTokenInformation function to specify what information about the token to return.
    /// </summary>
    /// <remarks>MSDN: http://msdn.microsoft.com/en-us/library/windows/desktop/aa379626(v=vs.85).aspx </remarks>
    internal enum TokenInformationClass
    {
        ...
        /// <summary>
        /// The buffer receives a TOKEN_APPCONTAINER_INFORMATION structure that contains the AppContainerSid associated with the token. If there are no app containers in the token, the TokenAppContainer member of the TOKEN_APPCONTAINER_INFORMATION structure points to NULL.
        /// </summary>
